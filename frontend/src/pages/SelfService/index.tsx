  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {catalogItems.map((item) => (
        <div key={item.id} className="bg-white rounded-lg border p-5 hover:shadow-md transition-shadow">
          <div className="w-10 h-10 rounded-lg bg-brand-light flex items-center justify-center text-brand text-xl mb-3">
            &#9881;
          </div>
          ...
          <button
            ...
            className="w-full bg-brand text-white py-2 rounded-lg text-sm hover:bg-brand-hover"
          >
            요청하기
          </button>
        </div>
